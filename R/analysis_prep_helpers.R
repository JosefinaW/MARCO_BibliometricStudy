...
#' Remove controls that are replicated originals. The comparator pool is registered
#' as non-replicated articles. A control counts as replicated if FLoRA lists a
#' replication of it (data/flora_replicated_originals.csv, built by
#' R/flora_replicated_originals.R) or if it heads its own matching group in
